  ...
  return (
    <div className="mx-auto max-w-7xl px-4">
      <div className="flex justify-center">
        <h1 className="font-pre-heading-01 text-blue-700">채용정보</h1>
        <h1 className="font-pre-heading-01">&nbsp;둘러보기</h1>
      </div>
      <div className="flex space-x-4">
        <div className="w-spacing-19 sticky top-4 mt-10 max-h-screen shrink-0 overflow-y-auto transition-all duration-700 ease-in-out">
